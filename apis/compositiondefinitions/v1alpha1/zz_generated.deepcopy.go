...
func (in *CompositionDefinitionSpec) DeepCopyInto(out *CompositionDefinitionSpec) {
	*out = *in
	...
	if in.StatusDataTemplate != nil {
		in, out := &in.StatusDataTemplate, &out.StatusDataTemplate
		*out = make([]StatusFieldMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesTargetStatus) DeepCopyInto(out *KubernetesTargetStatus) {
	*out = *in
	in.ConditionedStatus.DeepCopyInto(&out.ConditionedStatus)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesTargetStatus.
func (in *KubernetesTargetStatus) DeepCopy() *KubernetesTargetStatus {
	if in == nil {
		return nil
	}
	out := new(KubernetesTargetStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteInstall) DeepCopyInto(out *RemoteInstall) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteInstall.
func (in *RemoteInstall) DeepCopy() *RemoteInstall {
	if in == nil {
		return nil
	}
	out := new(RemoteInstall)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RemoteInstall) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteInstallList) DeepCopyInto(out *RemoteInstallList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RemoteInstall, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteInstallList.
func (in *RemoteInstallList) DeepCopy() *RemoteInstallList {
	if in == nil {
		return nil
	}
	out := new(RemoteInstallList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RemoteInstallList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteInstallSpec) DeepCopyInto(out *RemoteInstallSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteInstallSpec.
func (in *RemoteInstallSpec) DeepCopy() *RemoteInstallSpec {
	if in == nil {
		return nil
	}
	out := new(RemoteInstallSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteInstallStatus) DeepCopyInto(out *RemoteInstallStatus) {
	*out = *in
	in.ConditionedStatus.DeepCopyInto(&out.ConditionedStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteInstallStatus.
func (in *RemoteInstallStatus) DeepCopy() *RemoteInstallStatus {
	if in == nil {
		return nil
	}
	out := new(RemoteInstallStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatusFieldMapping) DeepCopyInto(out *StatusFieldMapping) {
	*out = *in
	if in.Schema != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatusFieldMapping.
func (in *StatusFieldMapping) DeepCopy() *StatusFieldMapping {
	if in == nil {
		return nil
	}
	out := new(StatusFieldMapping)
	in.DeepCopyInto(out)
	return out
}
