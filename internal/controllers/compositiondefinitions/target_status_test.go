...
func clientsetWithVersion(t *testing.T, gitVersion string) *fake.Clientset {
	t.Helper()
...
func TestSetTargetStatus_LocalHealthy(t *testing.T) {
	e := &external{client: clientsetWithVersion(t, "v1.30.2")}
...
func TestSetTargetStatus_RemoteRecordsSecretVersion(t *testing.T) {
	e := &external{
		client:                clientsetWithVersion(t, "v1.29.0"),
		remote:                true,
